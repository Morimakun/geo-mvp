...
**実行日**: 2026-06-06  
**対象**: PDF P1, P8, P9, P10, P15, P28（6ページ）  
...
### 確認対象と要確認項目（needs_human_confirm=YES の 15件）

| pdf_p | page_idx | 項目 | v3値 | CSV値 | 理由 |
|------|----------|------|------|-------|------|
| P1 | 0 | AV | 0 | 1 | 案件欄なのに0？空欄誤読か |
| P8 | 7 | AU | 0 | 1 | 案件欄なのに0？空欄誤読か |
